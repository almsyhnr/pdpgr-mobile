...
class TambahPengajuanJamban extends ValidationComponent {
  ...
  constructor (props) {
    ...
    this.state = {
      form: {
        ...
        sub_village: '',
        kepemilikan_jamban: '',
        jarak_sumber_air_tpa: '',
        sumber_air_minum: '',
        sumber_listrik_jamban: ''
      },
      images: [],
      modul: _module,
      subVillages: []
  ...
  onSavePress = () => {
    this.validate({
      ...
      kepemilikan_jamban: { required: true },
      jarak_sumber_air_tpa: { required: true },
      sumber_air_minum: { required: true },
      sumber_listrik_jamban: { required: true }
    })
      ...
      <View style={styles.container}>
        <KeyboardAwareScrollView style={styles.container}>
          ...
          <View style={{marginTop: 30, backgroundColor: Colors.snow, padding: 20}}>
            ...
            <Text style={styles.label}>Kepemilikan Jamban</Text>
            <RNPickerSelect
              placeholder={{
                label: 'Pilih Salah Satu',
                value: null
              }}
              items={kepemilikanJamban}
              onValueChange={(value) => {
                this.onValueChange('kepemilikan_jamban', value)
              }}
              value={this.state.form.kepemilikan_jamban}
              style={{ ...pickerSelectStyles }}
                />

            <Text style={styles.label}>Sumber Air Minum</Text>
            <RNPickerSelect
              placeholder={{
                label: 'Pilih Salah Satu',
                value: null
              ...
              items={sumberAir}
              onValueChange={(value) => {
                this.onValueChange('sumber_air_minum', value)
              }}
              value={this.state.form.sumber_air_minum}
              style={{ ...pickerSelectStyles }}
                />
            <Text style={styles.label}>Jarak Sumber Air Minum ke TPA Tinja</Text>
            <RNPickerSelect
              placeholder={{
                label: 'Pilih Salah Satu',
                value: null
              ...
              items={jarakTpa}
              onValueChange={(value) => {
                this.onValueChange('jarak_sumber_air_tpa', value)
              }}
              value={this.state.form.jarak_sumber_air_tpa}
              style={{ ...pickerSelectStyles }}
                />

            <Text style={styles.label}>Sumber Listrik</Text>
            <RNPickerSelect
              placeholder={{
                label: 'Pilih Salah Satu',
                value: null
              ...
              items={sumberListrik}
              onValueChange={(value) => {
                this.onValueChange('sumber_listrik_jamban', value)
              }}
              value={this.state.form.sumber_listrik_jamban}
              style={{ ...pickerSelectStyles }}
                />
          </View>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(TambahPengajuanJamban)

const kepemilikanJamban = [
  {
    label: 'Ada',
    value: 'Ada'
  },
  {
    label: 'Bersama/MCK Komunal',
    value: 'Bersama/MCK Komunal'
  },
  {
    label: 'Tidak Ada',
    value: 'Tidak Ada'
...
const sumberListrik = [
  {
    label: 'PLN dengan Meteran',
    value: 'PLN dengan Meteran'
  },
  {
    label: 'PLN tanpa Meteran',
    value: 'PLN tanpa Meteran'
  },
  {
