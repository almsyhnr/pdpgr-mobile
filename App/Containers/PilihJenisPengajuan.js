  ...
  openTambahPengajuan = (modul) => {
    ...
    switch (modul.id) {
      ...
      case 2:
        ...
        break
      case 3:
        navigate('TambahPengajuanPaririSehat', param)
        break
      case 5:
        navigate('TambahPengajuanBaririTani', param)
        break
      case 6:
        navigate('TambahPengajuanBaririNelayan', param)
        break
      case 7:
        navigate('TambahPengajuanJamban', param)
        break
      case 8:
